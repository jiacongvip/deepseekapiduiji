...
export default {
            ...
            return {
                models: [
                    ...
                    },
                    {
                        ...
                        description: 'DeepSeek chat model via adapter',
                        inputTokenLimit: 32768,
                        outputTokenLimit: 2048,
                        supportedGenerationMethods: ['generateContent', 'streamGenerateContent']
                    }
    ...
    post: {
        ...
        '/models/:model\\:generateContent': async (request: Request) => {
            ...
            // If environment variable has token, use it
            if (DEEP_SEEK_CHAT_AUTHORIZATION) {
                authHeader = "Bearer " + DEEP_SEEK_CHAT_AUTHORIZATION;
            }
            ...
            const { contents, systemInstruction, conversation_id: convId } = request.body;
